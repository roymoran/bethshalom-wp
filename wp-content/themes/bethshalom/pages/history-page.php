...
<section class="section">
    ...
    <div class="data-visuals">
        ...
        <table  style="margin: 25px;" align="center">
            ...
            <tr>
                <td>James Y. Poinsett</td>
                <td>G. Marshall</td>
            </tr>

            <tr>
                <td>Joshua V. Salter</td>
                <td>H.S. Scott</td>
            </tr>
            ...
            <tr>
                <td>Shelomi D. Levy</td>
                <td>Levi Ben Levy, Chief Rabbi</td>
            </tr>

            <tr>
                <td>Sholomo B. Levy</td>
                <td>Lazarus</td>
            </tr>
            ...
            <tr>
                <td>Yehoshua B. Yahonatan</td>
                <td>Matthew. Stephens</td>
            </tr>

            <tr>
                <td>Yeshurun Eleazar</td>
                <td>Moses</td>
            </tr>
            ...
            <tr>
                <td>Zacharia Ben Levi</td>
                <td>Raphael Tate</td>
            </tr>

            <tr>
                <td>Zakar Yeshurun</td>
                <td>Walcott</td>
            </tr>

            <tr>
                <td>Zidkiyahu Levy</td>
                <td>Wentworth A. Mathew, Founder</td>
            </tr>
            ...
            <tr>
                <td></td>
                <td>* Rabbis who studied with other institutions <br>
                    ** Honorary Titles</td>
            </tr>
        </table>
    </div>
